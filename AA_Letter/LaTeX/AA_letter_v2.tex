...
the resulting kilonovae with the next generation electromagnetic observatories such as ATHENA, LSST, BlackGEM.
%Here we explore this intriguing possibility...\\
Here, we investigate the potential issues in the follow-up work like SNIa posing as kilonovae in the optical band.
...
in units of $D^{-3}\,\text{yr}^{-1}$ within each concentric shell.
