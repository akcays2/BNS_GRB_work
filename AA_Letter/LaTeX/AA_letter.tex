...
The LSST can reach a 5$\sigma$ limiting magnitude of $r\sim24.3$ with 2$\times$15~s images. The readout times for each exposure will be 2~s, and as the field of view of LSST is 9.6 deg$^2$ \sa{3.5?}, we will likely be able to cover the entire GW footprint in a small number of pointings. Even allowing 5 minutes for slewing of the telescope, it is likely that obtaining pre-merger images will take at most 10 minutes.
