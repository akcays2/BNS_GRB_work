...
each $D$ computed using a flat $\Lambda$CDM model ($\Omega_k=0$) with the latest Planck satellite parameters: 
...
%
\begin{table}[h]
\caption{Event rates, the figures have been rounded when appropriate
