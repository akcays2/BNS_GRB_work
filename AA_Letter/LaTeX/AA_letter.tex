...
\sa{TO DO make ETC thick red, make ALIGO dashed, replace ET-B by CE, bigger x-y labels and tick marks, bigger legend cutoff plot at ~2000Hz?}
}
\label{fig:ETB2030}
\end{figure}
%
...
Rounding down to 5\% to err on the side of caution, we obtain 5 yearly BNS transients with $\Delta\Omega \lesssim 10\,$deg$^2$ and 20 transients with $\Delta\Omega \lesssim 20\,$deg$^2$ within 400\,Mpc corresponding to $T_\text{AW}\gtrsim 1.5\,$hrs.

(i) at $f=5\,$Hz, the strain of a BNS at this distance is $10^{-22}$ (Fig.~\ref{fig:ETB2030}), 
(ii) the event rate is roughly 100 (Table~\ref{table:ET}).
