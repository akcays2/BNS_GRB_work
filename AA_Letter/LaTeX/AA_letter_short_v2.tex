...
We also show the sensitivity curves for Cosmic Explorer (blue) and KAGRA+ (brown) with the solid curves representing their RMS-averaged sensitivity and the bottom of each shaded region, the maximum optimal sensitivity.
